      ...
      <div style={{width: 1127, height: 29, left: 0, top: 0, position: 'absolute'}}>
        ...
        <div style={{width: 1006.25, height: 29, left: 0, top: 0, position: 'absolute'}}>
          ...
          <div style={{width: 1006.25, height: 27, left: 0, top: 2, position: 'absolute'}}>
            ...
            <div style={{left: 802, top: 2, position: 'absolute', color: 'black', fontSize: 20, fontFamily: 'Outfit', fontWeight: '600', wordWrap: 'break-word',cursor: 'pointer'}}onClick={handlequestions}>Questions</div>
          </div>
        </div>
      </div>
      <div style={{left: 1165, top: 0, position: 'absolute', color: 'black', fontSize: 20, fontFamily: 'Outfit', fontWeight: '600', wordWrap: 'break-word',cursor: 'pointer'}}onClick={handleadmin}>LogOut</div>
    </div>
      {/* <h2>Values Landing Page</h2> */}
      <div style={{width: '1000px', height: '434px', left: '100px', top: '170px', position: 'absolute', color: 'black', fontSize: '20px', fontFamily: 'Outfit', fontWeight: 400, wordWrap: 'break-word'}}>Welcome, Admin! This is your dedicated dashboard for monitoring and analyzing website's performance. We understand the importance of data-driven decisions, and here, you'll find all the key metrics and insights you need to assess website's effectiveness.</div>
