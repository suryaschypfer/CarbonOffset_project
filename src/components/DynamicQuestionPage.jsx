...
const fetchCarbonFootprintAndTrees = async () => {
  ...
  return (
    ...
    <nav className="nav-bar" style={{ borderBottom: '1px solid #000', display: 'flex', width: '103%' }}>
    ...
    <div style={{ width: '916px', height: '848px', left: '50px', position: 'absolute' }}>
    ...
    {/* <div style={{ width: '1500px', height: '70px', left: '-150px', position: 'absolute', background: '#ff9d76'}}></div> */}
    <div style={{ width: '1400px', height: '70px', left: '-150px', position: 'absolute', bottom: '0', background: '#ff9d76'}}></div>
