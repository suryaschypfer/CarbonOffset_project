...
const ValuesLandingPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      >
        Welcome, Admin! This is your dedicated dashboard for monitoring and
        analyzing website's performance. We understand the importance of
        data-driven decisions, and here, you'll find all the key metrics and
        insights you need to assess website's effectiveness.
      </div>
